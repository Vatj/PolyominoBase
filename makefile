...
INC         := -I$(INCDIR) -I$(BOOSTDIR)
INCDEP      := -I$(INCDIR) -I$(BOOSTDIR)
# INCBOOST    := /scratch/vatj2/boost_1_67_0/stage/lib/libboost_regex.a
# INCBOOST    := -L$(BOOSTDIR)/stage/lib/ -lboost_regex
INCBOOST    := -L$(BOOSTDIR)/stage/lib/ -lboost_program_options
